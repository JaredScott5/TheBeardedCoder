...
<nav class="navbar navbar-expand-lg navbar-light bg-faded py-lg-4">
    <a class="navbar-brand text-uppercase text-expanded font-weight-bold d-lg-none" href="#">The Bearded Coder</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mx-auto" id="navbarContents">
          <!--TODO create  a js that makes a class 'active' pased on what page you're on for the lis-->
            ...
            <li class="nav-item px-lg-4" id="blog">
                <a class="nav-link text-uppercase text-expanded" href="blog.php">Blog</a>
            </li>
            <li class="nav-item px-lg-4" id="contact">
                <a class="nav-link text-uppercase text-expanded" href="contact.php">Contact</a>
            </li>
        </ul>
    </div>
    <script src="vendor/bootstrap/js/navbarlihighlight.js"></script>
