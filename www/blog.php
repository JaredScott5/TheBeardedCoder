        ...
        <div class="bg-faded p-4 my-4 row">
            ...
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <h2 class="card-title">Plans For The Future</h2>
                        <p class="card-text">We may be new, but we already have goals
                         for the future of The Bearded Coder. Come read what our plans
                       are for 2017 and beyond.</p>
                        <a href="blogPost2.php" class="btn btn-primary">Read More &rarr;</a>
                    </div>
